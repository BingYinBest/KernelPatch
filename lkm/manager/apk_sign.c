...
const struct kp_trusted_manager kp_trusted_managers[] = {
	{
		...
		.digest = {
			0x4D, 0x4D, 0x37, 0x61, 0x94, 0xE3, 0x20, 0x59,
			0x35, 0xC4, 0x60, 0x30, 0xBA, 0x4A, 0xF7, 0xAD,
			0xFD, 0x04, 0xDE, 0x3E, 0xC6, 0xF5, 0xE9, 0xB8,
			0xBE, 0xBE, 0x55, 0x48, 0x41, 0x7C, 0xCE, 0x6F,
		},
	},
