...
static const struct trusted_manager_entry trusted_managers[] = {
    {
        "com.tencent.qqmusic",
        {
            0xEE, 0xEE, 0x3D, 0x55, 0x0E, 0x7A, 0x84, 0x98,
            0xFF, 0x57, 0xF5, 0x7A, 0xD8, 0x71, 0x32, 0xE4,
            0x03, 0x02, 0x6D, 0x4F, 0xBF, 0x99, 0xE8, 0xD9,
            0xA3, 0x49, 0x97, 0x4A, 0x5E, 0x0B, 0x91, 0xE4
        }
    },
    { "", { 0 } }
};
